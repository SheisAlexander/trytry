            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(progress == 0){
                    ...
                    sortbutton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(YourLevel.this, Level1.class);
                            startActivity(intent);
                        }
                    });
                }
                    ...
                    sortbutton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(YourLevel.this, Settings.class);
                            startActivity(intent);
                        }
                    });
                }
                    ...
                    sortbutton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(YourLevel.this, Test.class);
                            startActivity(intent);
                        }
                    });
                }
