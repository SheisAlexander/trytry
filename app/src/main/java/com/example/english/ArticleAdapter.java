...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.MyViewHolder> {
    ...
    public ArticleAdapter(ArrayList<String> titles, ArrayList<String> keywords1, ArrayList<String> keywords2, ArrayList<String> keywords3, ArrayList<String> keywords4, ArrayList<String> keywords5, ArrayList<String> keywords6, ArrayList<String> articles, ArrayList<String> english_ids) {
        this.titles = titles;
        ...
        public MyViewHolder(@NonNull View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //start new intent
                    Intent i = new Intent(v.getContext(),articleh.class);
